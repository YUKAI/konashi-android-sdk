...
public class KonashiUtilsTest {
    ...
    public void testGetPwmPeriod() {
        ...
        Mockito.when(mCharacteristic.getValue()).thenReturn(values);
        assertThat(KonashiUtils.getPwmPeriod(mCharacteristic)).isEqualTo(10000);
    }
    ...
    public void testGetPwmDuty() {
        byte[] values = new byte[]{0x01, 0x00, 0x00, 0x27, 0x10};
        Mockito.when(mCharacteristic.getValue()).thenReturn(values);
        assertThat(KonashiUtils.getPwmDuty(mCharacteristic)).isEqualTo(10000);
    }
    ...
    public void testGetUartBaudrate() {
        ...
        Mockito.when(mCharacteristic.getValue()).thenReturn(values);
        assertThat(KonashiUtils.getUartBaudrate(mCharacteristic)).isEqualTo(0x0028);
    }
    ...
    public void testGetUartWriteData() {
        ...
        Mockito.when(mCharacteristic.getValue()).thenReturn(values);
        assertThat(KonashiUtils.getUartWriteData(mCharacteristic)).isEqualTo(new byte[]{0x74, 0x65, 0x73, 0x74});
    }
    ...
    public void testGetI2cWriteAddress() {
        ...
        Mockito.when(mCharacteristic.getValue()).thenReturn(values);
        assertThat(KonashiUtils.getI2cWriteAddress(mCharacteristic)).isEqualTo((byte) 0x1f);
    }
