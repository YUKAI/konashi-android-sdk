...
public class I2cModeActionTest {
    ...
    public void setValue_ToEnable400k() throws Exception {
        mAction = new I2cModeAction(mService, 0x02);
        mAction.setValue();
        verify(mCharacteristic, times(1)).setValue(mValueCaptor.capture());
